...
public class ChatListener implements Listener {
    ...
    public void onChat(AsyncPlayerChatEvent event) {
        ...
        String nameToken = "%1$s"; // player name placeholder in format string
        String baseFormat = event.getFormat(); // preserve any prefixes/suffixes from other plugins
        ...
        if (baseFormat != null && baseFormat.contains(nameToken)) {
            ...
            // Fallback if some plugin nuked %1$s: minimally add title and keep message
