...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (getCommand("칭호아이템") != null) { getCommand("칭호아이템").setExecutor(new cmd_AdminItem(this)); } else { getLogger().severe("Command not found: 칭호아이템"); }
        if (getCommand("색깔채팅") != null) { getCommand("색깔채팅").setExecutor(new ColorChatCommand(this, colorChatService, colorChatGUI)); } else { getLogger().severe("Command not found: 색깔채팅"); }
