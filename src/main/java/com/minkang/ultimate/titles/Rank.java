...
public class Rank {
    ...
    public final String suffix; // not used for auto-promote; kept for backward compat
    public final int limitLegendary;
    public final int limitMegaboss;

    public Rank(String id, String display, int requiredMinutes, String group, String suffix, int limitLegendary, int limitMegaboss) {
        this.id = id;
