...
public class TitleService {
    ...
    public TitleService(Main plugin) { this.plugin = plugin; }

    public Map<Integer, String> getGeneratedTitles() { return generatedTitles; }
    ...
    public void applyTitle(Player p, String title) { applyTitleSuffix(p, title, null); }
    ...
    public void applyTitleSuffix(Player p, String suffixRaw, Integer slot) {
        ...
        PlayerData d = plugin.storage().get(p.getUniqueId());
        if (slot != null) d.setActiveTitleSlot(slot);
